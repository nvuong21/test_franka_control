...
if __name__ == "__main__":
    rospy.init_node("desire_pose_node")
    ...
    pose_pub = rospy.Publisher(
        "desire_pose", PoseStamped, queue_size=10)
    server = InteractiveMarkerServer("desire_pose_marker")
    int_marker = InteractiveMarker()
    int_marker.header.frame_id = link_name
    int_marker.scale = 0.3
    int_marker.name = "desire_pose"
    int_marker.description = ("Desire Pose\nBE CAREFUL! "
                              "If you move the \nequilibrium "
